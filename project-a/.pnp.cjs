...
function $$SETUP_STATE(hydrateRuntimeState, basePath) {
  return hydrateRuntimeState({
    ...
    "ignorePatternData": "(^(?:\\.yarn\\/sdks(?:\\/(?!\\.{1,2}(?:\\/|$))(?:(?:(?!(?:^|\\/)\\.{1,2}(?:\\/|$)).)*?)|$))$)|(^(?:\\.\\.\\/project-b)$)",
    ...
    "packageRegistryData": [
      [null, [
        [null, {
          ...
          "packageDependencies": [
            ...
            ["lodash", "npm:4.17.21"],
            ["p-c", "portal:../project-c::locator=lib-a%40workspace%3A."],
            ["react", "npm:17.0.2"]
          ],
          "linkType": "SOFT",
        }]
      ...
      ["p-c", [
        ["portal:../project-c::locator=lib-a%40workspace%3A.", {
          "packageLocation": "../project-c/",
          "packageDependencies": [
            ["p-c", "portal:../project-c::locator=lib-a%40workspace%3A."],
            ["lodash", "npm:4.17.21"],
            ["react", "npm:17.0.2"]
